	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td><input name="btnCancelar" type="submit" id="btnCancelar" value="Cancelar" onclick="ajax('controllers/gestionarCurriculum/CtlCurriculum.php', 1, 'vacio', 'contenido')"/></td>
			</tr>
	</tbody>
  </table>
