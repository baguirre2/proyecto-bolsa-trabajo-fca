    ...
    function __construct($GET) {
        ...
        switch ($opc) {
            ...
            case 'certi_listar';
                ...
                echo "<input type=\"button\" name=\"Agregar\" value=\"Agregar Certificaci髇\" onclick=\"ajax('controllers/gestionarCurriculum/CtlCurriculum.php', 'certi_registrar', 'vacio', 'contCurr');\">";
