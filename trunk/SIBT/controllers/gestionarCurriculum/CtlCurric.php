...
session_start();
session_start();
$_SESSION['id_alumno'] = 3;  //aquÌ ir· el id del alumno que ingrese al SIBT
$_SESSION['carrera_alumno'] = 'Inform·tica'; //aquÌ ir· la carrera del alumno que ingrese al SIBT
session_destroy();
...
//            	echo $_SESSION['idUsuario'];
            ...
            echo "<h1>&nbsp;</h1>";
            //Llamar al modelo para listar la informaciÔøΩn acadÔøΩmica que tiene el alumno
            //Mostrar en cada una la opciÔøΩn de editar si estÔøΩ confirmado
            ...
            case 'registrar'; 
                    ...
                    echo "<h1>He registrado tus datos $_GET[nomAlum].
                            Tu Direcci√≥n es: $_GET[dirAlum]</h1>";
                break;
        }
    }
    
    //function registrarAlumno ($_GET) {
    //Recibe los datos de la petici√≥n y crea una Entity, que los almacena en la BD
