...
class CtlAlumno {
    ...
    function __construct($GET, $FILES) {
        ...
        switch ($opc) {
            ...
            //*****************     AQUI TERMINAN LOS CASE PARA CARGA DE ARCHIVOS        *******************
                ...
                case 'obDeMu';			//Obtiene DelegaciÃ³n/Municipio de manera dinÃ¡mica [a travÃ©s de JS].
                ...
                case 'obColonia';		//Obtiene Colonia de manera dinÃ¡mica [a travÃ©s de JS].
                	include '../../boundaries/alumno/divMiDireccion.php';
                	$dir = new Alumno();
    ...
    public function procesarArchivo($file) {
        ...
        //sino hay errores movemos el archivo temporal a nuestra carpeta                 
            ...
            $CSV = $manCSV->abrirArchivo("/opt/lampp/htdocs/SIBT/controllers/gestionarAlumno/files/$nomFile"); //<---AquÃ­ le das la direcciÃ³n del archivo, una vez que se cargo al servidor
